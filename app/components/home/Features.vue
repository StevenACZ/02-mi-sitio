...
const cards = ref([
  ...
  },
  {
    title: "Fuentes",
    description:
      "Nuxt UI se integra con Nuxt Fonts para ofrecer optimización de fuentes plug-and-play.",
...
<template>
  <UPageSection
    title="servicios"
    description="Una gran variedad de servicios para ayudarte a construir aplicaciones increíbles"
    headline="Servicios"
  />
